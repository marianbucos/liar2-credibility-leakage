...
class LiarModel(nn.Module):
    ...
    def forward(self, text, metadata_text, metadata_number, justification):
        ...
        fused_output = self.fuse(torch.cat((text_output, metadata_output_text, metadata_output_number, metadata_output_number_fuzzy), dim=1))
