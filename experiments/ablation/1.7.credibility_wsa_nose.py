...
workspace_map = {
    ...
    'wsa':      '../../data/liar2_wsa/',
    'lfa':      '../../data/liar2_lfa/',
    'wsa_nose': '../../data/liar2_wsa_no_self_exclusion/',
    'psa_se':   '../../data/liar2_psa_se/',
}
worksapce = workspace_map[dataset]

model_name = '1.7.credibility'
model_save = model_name + '_wsa_nose.pt'
...
class LiarModel(nn.Module):
    ...
    def forward(self, text, metadata_text, metadata_number, justification):
        ...
        fused_output = self.fuse(torch.cat((metadata_output_number, metadata_output_number_fuzzy), dim=1))
