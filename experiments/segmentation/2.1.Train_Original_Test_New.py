...
model_save = '2.1.Train_Original_Test_New.pt'
model_name = '2.1.Train_Original_Test_New'
num_epochs = 10
batch_size = 32
learning_rate = 1e-3
num_classes = 6
...
train_data = pd.read_csv(worksapce + 'LIAR2023_pt1_origin.csv')
test_data = pd.read_csv(worksapce + 'LIAR2023_pt2_new.csv')
val_data = pd.read_csv(worksapce + 'LIAR2023_pt2_new.csv')
