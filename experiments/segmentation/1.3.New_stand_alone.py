...
model_save = '1.3.New_stand_alone.pt'
model_name = '1.3.New_stand_alone'
num_epochs = 10
batch_size = 32
learning_rate = 1e-3
num_classes = 6
...
train_data = pd.read_csv(worksapce + 'New_8_1_1_train.csv')
test_data = pd.read_csv(worksapce + 'New_8_1_1_test.csv')
val_data = pd.read_csv(worksapce + 'New_8_1_1_val.csv')
