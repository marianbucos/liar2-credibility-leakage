...
model_save = '3.1.Train_Original_Test_New_8_1_1.pt'
model_name = '3.1.Train_Original_Test_New_8_1_1'
num_epochs = 10
batch_size = 32
learning_rate = 1e-3
num_classes = 6
...
train_data = pd.read_csv(worksapce + 'Train_origin_test_new_train.csv')
test_data = pd.read_csv(worksapce + 'Train_origin_test_new_test.csv')
val_data = pd.read_csv(worksapce + 'Train_origin_test_new_val.csv')
