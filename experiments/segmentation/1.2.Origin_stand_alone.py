...
model_save = '1.2.Origin_stand_alone.pt'
model_name = '1.2.Origin_stand_alone'
num_epochs = 10
batch_size = 32
learning_rate = 1e-3
num_classes = 6
...
train_data = pd.read_csv(worksapce + 'Origin_8_1_1_train.csv')
test_data = pd.read_csv(worksapce + 'Origin_8_1_1_test.csv')
val_data = pd.read_csv(worksapce + 'Origin_8_1_1_val.csv')
