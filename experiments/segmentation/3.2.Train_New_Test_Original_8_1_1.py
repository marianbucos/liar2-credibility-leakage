...
model_save = '3.2.Train_New_Test_Original_8_1_1.pt'
model_name = '3.2.Train_New_Test_Original_8_1_1'
num_epochs = 10
batch_size = 32
learning_rate = 1e-3
num_classes = 6
...
train_data = pd.read_csv(worksapce + 'Train_new_test_origin_train.csv')
test_data = pd.read_csv(worksapce + 'Train_new_test_origin_test.csv')
val_data = pd.read_csv(worksapce + 'Train_new_test_origin_val.csv')
