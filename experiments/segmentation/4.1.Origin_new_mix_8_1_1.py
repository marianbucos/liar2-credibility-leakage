...
model_save = '4.1.Origin_new_mix_8_1_1.pt'
model_name = '4.1.Origin_new_mix_8_1_1'
num_epochs = 10
batch_size = 32
learning_rate = 1e-3
num_classes = 6
...
train_data = pd.read_csv(worksapce + 'Origin_new_mix_8_1_1_train.csv')
test_data = pd.read_csv(worksapce + 'Origin_new_mix_8_1_1_test.csv')
val_data = pd.read_csv(worksapce + 'Origin_new_mix_8_1_1_val.csv')
